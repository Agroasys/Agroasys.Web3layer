module.exports = class Data1770201981356 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "dispute_proposal" ("id" character varying NOT NULL, "proposal_id" text NOT NULL, "dispute_status" character varying(7) NOT NULL, "approval_count" integer NOT NULL, "executed" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "proposer" text NOT NULL, "trade_id" character varying, CONSTRAINT "PK_bfd7c0b2df03d36d6be8cf84486" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "oracle_update_proposal" ("id" character varying NOT NULL, "proposal_id" text NOT NULL, "new_oracle" text NOT NULL, "approval_count" integer NOT NULL, "executed" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "eta" numeric NOT NULL, "proposer" text NOT NULL, CONSTRAINT "PK_7b7c1d4d793fd1804e03c125a67" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "admin_add_proposal" ("id" character varying NOT NULL, "proposal_id" text NOT NULL, "new_admin" text NOT NULL, "approval_count" integer NOT NULL, "executed" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "eta" numeric NOT NULL, "proposer" text NOT NULL, CONSTRAINT "PK_1a0a8da5c7926e655a2ab8e5494" PRIMARY KEY ("id"))`)
